...
import { formatCurrency, formatDateTime, getPaymentTypeLabel } from "@/utils/storage";
    ...
    <ScreenScrollView>
      ...
      <View style={[styles.receiptCard, { backgroundColor: theme.backgroundDefault, borderColor: theme.border }]}>
        ...
        <View style={styles.amountSection}>
          ...
          <ThemedText type="h1" style={{ color: successColor, marginTop: Spacing.xs }}>
        ...
        <View style={styles.detailsSection}>
          {[
            ["Transaction ID", payment.transactionId],
            ["Date and Time", formatDateTime(payment.createdAt)],
            ["Payment Type", getPaymentTypeLabel(payment.type)],
      ...
      <View style={styles.actionsRow}>
        ...
        >
          ...
          <ThemedText type="small" style={{ color: primaryColor, marginTop: Spacing.xs, fontWeight: "500" }}>
            Share
          </ThemedText>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  successSection: { alignItems: "center", paddingTop: Spacing.xl },
  successIcon: { width: 96, height: 96, borderRadius: 48, alignItems: "center", justifyContent: "center" },
  successTitle: { textAlign: "center" },
  successSubtitle: { textAlign: "center", marginTop: Spacing.sm },
  receiptCard: { borderRadius: BorderRadius.lg, borderWidth: 1, overflow: "hidden" },
  receiptHeader: { flexDirection: "row", alignItems: "center", padding: Spacing.xl },
  mcLogo: { width: 48, height: 48, borderRadius: BorderRadius.sm, alignItems: "center", justifyContent: "center" },
  receiptHeaderText: { marginLeft: Spacing.lg },
  divider: { height: 1 },
  amountSection: { alignItems: "center", padding: Spacing.xl },
  ...
  actionButton: { flex: 1, alignItems: "center", justifyContent: "center", padding: Spacing.lg, borderRadius: BorderRadius.md },
});
